            ...
            <Fragment>
              <div className="App">
                ...
                <Switch>
                  ...
                  <Route path="/splist-psa" exact component={SPlistPsa} />
                  <Route path="/splist-usi" exact component={SPlistUsi} />
                  <Route path="/splist-isi" exact component={SPlistIsi} />
                  <Route path="/splist-cpt" exact component={SPlistCpt} />
                  <Route path="/splist-mg" exact component={SPlistMg} />
